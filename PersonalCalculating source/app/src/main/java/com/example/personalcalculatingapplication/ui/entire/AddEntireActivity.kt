...
class AddEntireActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        et_date.setOnClickListener {
            ...
            datePickerDialog.show(
                (this@AddEntireActivity as Activity).fragmentManager,
        ...
        btSave.setOnClickListener {
            ...
            item.addEntire(Entire(subject.toString(), cost, date, desc , hasNoitfy))
