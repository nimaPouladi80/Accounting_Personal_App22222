package com.example.personalcalculatingapplication.ui.loan
...
import com.example.personalcalculatingapplication.adapters.LoanItemsAdapter
...
class LoanListActivity: AppCompatActivity() , LoanItemsAdapter.AdapterListener{

    lateinit var item: CalculatingDatabaseHelper
    var selectedFirstDate = ""
    var selectedSecondDate = ""
    lateinit var mList: ArrayList<Loan>
    lateinit var adapter: LoanItemsAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mList = item.getAllLoans() as ArrayList<Loan>
      rcv_items.layoutManager = LinearLayoutManager(this)
        adapter = LoanItemsAdapter(this)
