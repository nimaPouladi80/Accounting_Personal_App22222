package com.example.personalcalculatingapplication.ui.entire
...
import com.example.personalcalculatingapplication.adapters.EntireItemsAdapter
...
class EntireListActivity: AppCompatActivity() , EntireItemsAdapter.AdapterListener{

    lateinit var item: CalculatingDatabaseHelper
    var selectedFirstDate = ""
    var selectedSecondDate = ""
    lateinit var mList: ArrayList<Entire>
    lateinit var adapter: EntireItemsAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mList = item.getAllEntire() as ArrayList<Entire>
      rcv_items.layoutManager = LinearLayoutManager(this)
        adapter = EntireItemsAdapter(this)
    ...
    private fun getDiffList() {
        val finalList = ArrayList<Entire>()
        if (selectedFirstDate.isNotEmpty()) {
            if (selectedSecondDate.isNotEmpty()) {
                // has both date
                for (i in mList) {
