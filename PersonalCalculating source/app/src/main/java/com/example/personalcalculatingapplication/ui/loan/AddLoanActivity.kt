...
class AddLoanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tv_title.text = "اضافه کردن وام"

        bt_back.setOnClickListener { onBackPressed() }

        tv_loan_name.hint = "نام وام و توضیحات"
        ...
        et_date.setOnClickListener {
            ...
            datePickerDialog.show(
                (this@AddLoanActivity as Activity).fragmentManager,
        ...
        btSave.setOnClickListener {
            ...
            item.addLoan(Loan("وام", cost, date, desc , hasNoitfy))
